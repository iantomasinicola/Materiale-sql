...
CREATE TABLE CorsoSQL.query.table_with_json (json_column JSON);

INSERT INTO CorsoSQL.query.table_with_json (json_column)
VALUES 
...
CREATE TABLE CorsoSQL.query.table_with_xml (
    xml_column XML
);

INSERT INTO CorsoSQL.query.table_with_xml (xml_column)
VALUES
